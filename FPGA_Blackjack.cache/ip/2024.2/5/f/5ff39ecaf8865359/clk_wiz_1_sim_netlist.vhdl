...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_clk_wiz_1_clk_wiz is
  signal clk_in100_clk_wiz_1 : STD_LOGIC;
  signal clk_out50_clk_wiz_1 : STD_LOGIC;
...
clkin1_ibufg: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in100,
      O => clk_in100_clk_wiz_1
    );
clkout1_buf: unisim.vcomponents.BUFG
     port map (
      I => clk_out50_clk_wiz_1,
      O => clk_out50
    );
plle2_adv_inst: unisim.vcomponents.PLLE2_ADV
    generic map(
      ...
      CLKIN1 => clk_in100_clk_wiz_1,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKOUT0 => clk_out50_clk_wiz_1,
